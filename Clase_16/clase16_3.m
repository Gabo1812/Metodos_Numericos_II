...
gm = fegeometry("disipador_00.step");
figure(1)
pdegplot(gm, FaceLabels="on",FaceAlpha=0.5);
view(150,20)
%..........Crea el objeto del modelo.........
model = createpde();
importGeometry(model,'disipador_00.step');
%............
...
% h*u = r
T0 = 100; % grados, temp. cara plana
applyBoundaryCondition(model,"dirichlet", 'Face',57, 'r',T0,'h',1);

%Aplica condiciones de Neumann
% n*(c x nabla(u)) + q*u = g
applyBoundaryCondition(model,"neumann","Face",1:56,"g",0,"q",0)
applyBoundaryCondition(model,"neumann","Face",58,"g",0,"q",0)
T_inicial = 0;
